...
public class EquationTests {
  ...
  public void testAllTransitionsInTable() {
    EquationTable<
            Integer,
            Word<Boolean>,
            CompactMealyTransition<Object>,
            Object,
            CompactMealy<Word<Boolean>, Object>,
            Alphabet<Word<Boolean>>>
    ...
    testTab
        ...
        .forEach(
            eq -> {
              CompactMealyTransition<Object> trans =
                  testSystem.getTransition(eq.states(), eq.ins());
              assert trans != null;
            ...
            eq ->
                eq.getFullList()
                    .forEach(
                        p -> {
                          CompactMealyTransition<Object> trans =
                              testSystem.getTransition(p.getSecond(), p.getFirst());
                          assert trans != null;
