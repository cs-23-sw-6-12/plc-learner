...
public class NewSVGCoil extends NewSVGRungElement {
    ...
    public Path2D getShape(double x, double y) {
        ...
        path.curveTo(x + leftCurveStartAndEndXValue, y - curveYValue, x - leftCurveXValue, y, x + leftCurveStartAndEndXValue, y + curveYValue);
        path.moveTo(x + rightCurveStartAndEndXValue, y - curveYValue);
        path.curveTo(x + rightCurveStartAndEndXValue, y - curveYValue, x + rightCurveXValue, y, x + rightCurveStartAndEndXValue, y + curveYValue);
