...
/**
 * A representation of how an output can be produced. The given output can be produced by a one of
 * the list of "operations". This list can be viewed as a OR operation ("x produces output OR y
 * produces output OR ...").
 *
 * @param <S> States
 * @param <I> Input
...
public class Equation<S, I, O> {
  ...
  /**
   * Method used to extend how the output can be produced. Can be viewed as a pair ({@code in,s})
   * that (also) produces {@code out}.
   *
